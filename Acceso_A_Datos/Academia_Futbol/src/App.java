	...
	public static void main(String[] args) {
		...
		do {
			  System.out.print("\n⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
		        ...
		        System.out.println(" ⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
		        System.out.print("	1. Modificar Datos de Partidos   ");
		        System.out.print("2. Modificar Datos del Club   ");
			...
			case 1:
				// para modificar datos de partidos
			...
			case 2:
				...
				do {
					System.out.print("\n⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
			        System.out.print("     Modificar Datos del Club:     ");
			        System.out.println(" ⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
...
////////////////////////////////////////////////////////////////////////*****************************************************************////////////////////////////////////////////////////////////////////////////
	...
	private static void gestionarJugador(Scanner scanner) {
		...
		do {
			System.out.print("\n⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
	        System.out.print("     Modificar Datos de Jugador:     ");
	        System.out.println(" ⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
			System.out.println("\n");
			...
			case 1:
				...
				// jugadorDAO.guardar_en_fichero_binario(nuevoJugador); /////////////// lo
				// guardo al mismo tiempo dentro del Dao
				System.out.println("\n	Jugador creado exitosamente.");
				int idGenerado = nuevoJugador.getIdJugador();
				System.out.println("\n	Nuevo Jugador creado con ID: " + idGenerado);
	...
	private static Jugador crearJugador(Scanner scanner) {
		...
		// Crear un nuevo objeto Jugador con los datos proporcionados no se le envian
		// más porque el id lo obtenemos en la base de datos
	...
	private static void leerJugador(Scanner scanner, JugadorDAO jugadorDAO) {
		...
		Jugador jugadorLeido = jugadorDAO.leer_datos_BD(idJugador);// desde read record se recuperan los datos y nos
																	// devuelve un Jugador
	...
	private static void eliminarJugador(Scanner scanner, JugadorDAO jugadorDAO) {
		...
		// Verificar si el jugador existe antes de intentar eliminarlo usando readRecord
		// de nuevo
		Jugador jugadorExistente = jugadorDAO.leer_datos_BD(idJugador);
...
////////////////////////////////////////////////////////////////////////*****************************************************************////////////////////////////////////////////////////////////////////////////
	...
	private static void gestionarDirectivos(Scanner scanner) {
		...
		do {
			System.out.print("\n⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
	        System.out.print("     Modificar Datos de Directivos:     ");
	        System.out.println(" ⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽\n");
	...
	private static void eliminarDirectivo(Scanner scanner, DirectivoDAO directivoDAO) {
		...
		// Verificar si el directivo existe antes de intentar eliminarlo usando
		// leer_datos_BD
		Directivo directivoExistente = directivoDAO.leer_datos_BD(idDirectivo);
...
////////////////////////////////////////////////////////////////////////*****************************************************************////////////////////////////////////////////////////////////////////////////
	...
	private static void gestionarEquipo(Scanner scanner) {
		...
		do {
			System.out.print("\n⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
	        System.out.print("     Modificar Datos de Equipo:     ");
	        System.out.println(" ⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽\n");
			...
			case 5:
				...
				listarEquipos(scanner, equipoDAO);
	...
	private static Equipo crearEquipo(Scanner scanner) {
		...
		System.out.print(
				"El entrenador de este equipo lo debe asignar despúes\n** Recuerde que un equipo solo tiene un entrenador**");
		int entrenador = 0;
			...
			do {
				...
				case 2:
					...
					for (Entrenador entrenador : entrenadores) {
						System.out.println(
								"	id entrenador:" + entrenador.getIdEntrenador() + "	" + entrenador.getNombre() + " "
										+ entrenador.getApellidos() + "		Id de Equipo:" + entrenador.getIdEquipo()
										+ "		Meses de experiencia : " + entrenador.getMesesExp());
					}
					...
					// Validar que el ID del entrenador seleccionado esté en la lista de
					// entrenadores
					...
					Entrenador entrenadorAntiguo = obtenerEntrenadorPorId(equipoExistente.getEntrenador(),
							entrenadores);

					// Intercambiar equipos entre los dos entrenadores

					equipoDAO.actualizarEntrenadorEnEquipo(equipoExistente.getCodEquipo(),
							nuevoEntrenador.getIdEntrenador());
					...
					entrenadorDAO.actualizarEquipoEnEntrenador(equipoExistente.getCodEquipo(),
							nuevoEntrenador.getIdEntrenador());
					if (entrenadorAntiguo != null && entrenadorAntiguo.getIdEquipo() != 0) {
						// Actualizar id_equipo en el entrenador antiguo (ponerlo como no asignado)
						entrenadorDAO.actualizarEquipoEnEntrenador(entrenadorAntiguo.getIdEquipo(),
								entrenadorAntiguo.getIdEntrenador());
					...
					System.out.println("Código: " + equipoExistente.getCodEquipo());
					System.out.println("Estadio: " + equipoExistente.getEstadio());
					System.out.println("Entrenador: " + nuevoEntrenador.getIdEntrenador()); // Aquí mostramos el nuevo
																							// entrenador
					System.out.println("Categoría: " + equipoExistente.getCategoria());
					System.out.println("---------------------------");
					...
					// Verificar si el entrenador antiguo tenía un equipo asignado (id_equipo = 0
					// significa que no tiene equipo)
	...
	/*********************************
	 * Logica para verificar el entrenador elegido existe en la lista como pre
	 * requisito
	 *********************/
	...
	private static void listarEquipos(Scanner scanner, EquipoDAO equipoDAO) {
		System.out.println("Seleccione la fuente de datos:");
		System.out.println("1. Lista de la Base de Datos (SQLite)");
		System.out.println("2. Lista desde el Fichero Binario");
		System.out.print("Ingrese el número correspondiente a la opción deseada: ");
		...
		switch (opcionFuenteDatos) {
		case 1:
			equipos = equipoDAO.readRecords();
			break;
		case 2:
			equipos = equipoDAO.cargarArchivo();
			break;
		default:
			System.out.println("Opción no válida. Volviendo al menú principal.");
			return;
...
////////////////////////////////////////////////////////////////////////*****************************************************************////////////////////////////////////////////////////////////////////////////
	...
	private static void gestionarEntrenador(Scanner scanner) {
		...
		do {
			System.out.print("\n⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽");
	        System.out.print("     Modificar Datos de Entrenador:     ");
	        System.out.println(" ⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽⚽\n");
			...
			case 5:
				// Listar Entrenadores
				listarEntrenadores(scanner, entrenadorDAO);
				break;
			case 6:
				System.out.println("Volviendo al Menú Anterior.");
				break;
	...
	private static Entrenador crearEntrenador(Scanner scanner, EquipoDAO equipoDAO) {
		...
		// Obtener la lista de equipos sin entrenador, llamando al metodo que nos
		// devolvera la lista completa.
		...
		if (equiposSinEntrenador.isEmpty()) {
			System.out.println(
					"No hay equipos sin entrenador. Cada equipo solo puede tener un entrenador.\n debe existir un equipo sin entrenador.");
			return null;
		}
		...
		// Validar que el ID del equipo seleccionado esté en la lista de equipos sin
		// entrenador
		if (!validarIdEquipo(idEquipo, equiposSinEntrenador)) {
			System.out.println("Error: El ID del equipo seleccionado no es válido.");
			return null; // devuel null si el ID del equipo no es uno de la lista que se ha mostrado
							// antes :(
		}
	...
	private static boolean validarIdEquipo(int idEquipo, List<Equipo> equipos) {
		// Verificar que el ID del equipo seleccionado esté en la lista de equipos sin
		// entrenador
		for (Equipo equipo : equipos) {
	...
	private static void listarEntrenadores(Scanner scanner, EntrenadorDAO entrenadorDAO) {
		System.out.println("Seleccione la fuente de datos:");
		System.out.println("1. Lista de la Base de Datos (SQLite)");
		System.out.println("2. Lista desde el Fichero Binario");
		System.out.print("Ingrese el número correspondiente a la opción deseada: ");
		...
		switch (opcionFuenteDatos) {
		case 1:
			entrenadores = entrenadorDAO.readRecords();
			break;
		case 2:
			entrenadores = entrenadorDAO.cargarArchivo();
			break;
		default:
			System.out.println("Opción no válida. Volviendo al menú principal.");
			return;
